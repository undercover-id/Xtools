...
print("\n" + "-" * terminal_width)
print("[•] Pengaturan awal".center(terminal_width))
print("-" * terminal_width)
...
for i in range(jumlah_akun):
    print("\n" + "-" * terminal_width)
    print(f"[•] Masukkan cookie akun {i+1}".center(terminal_width))
    print("-" * terminal_width)
...
for akun in akun_list:
    print("\n" + "-" * terminal_width)
    print(f"[•] Memulai proses akun: {akun['username']}".center(terminal_width))
    print("-" * terminal_width)
    ...
    try:
        ...
        try:
            ...
            print(f"! Gagal follow @{target} — mungkin sudah difollow atau akun bermasalah")
