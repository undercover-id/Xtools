...
import json, time, random, os import undetected_chromedriver as uc from selenium.webdriver.common.by import By

===============================

Selamat datang di tools auto follow X

Author: @vick.undercover

===============================

terminal_width = 60 judul = "Selamat datang di tools auto follow X" penulis = "Author: @vick.undercover" print("\n" + "=" * terminal_width) print(judul.center(terminal_width)) print(penulis.center(terminal_width)) print("=" * terminal_width + "\n")
